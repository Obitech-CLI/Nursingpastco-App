...
function AddContentsForm({editFile, setEditFile, formData, setFormData, focus, setFocus, file, setFile, fileRef, loading, submit, edit, editData, setEditData, setEdit} : Props) {

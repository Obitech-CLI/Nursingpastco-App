...
function AddNewsCategory({editCategory, setEditCategory, setEditCategoryData, editCategoryData, setReloadCategories} : Props) {
    ...
    const HandleSubmitForm = async (e:React.FormEvent<HTMLFormElement>) =>
    {
        ...
        if (editCategory) {
            ...
            const res = await PatchFormData.Patch("/news/categories", editCategoryData);
            ...
            const res = await PostFormData.Post("/news/categories", {category: category});
